...
bin_edges = stats.mstats.mquantiles(data["DeletionSize"], [0, 2./6, 4./6, 1])
#print bin_edges
#sys.exit()
...
#plt.xticks(newticks)
#ax=sns.boxplot(x="Phenotype",y="FounderRate",hue="delivery_method",data=data,palette="muted")
